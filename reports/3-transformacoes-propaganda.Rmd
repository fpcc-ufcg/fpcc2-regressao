...
`y ~ log(x)` ainda não parece linear, e tem heteroscedasticidade (a variância do erro residual é diferente para diferentes valores de x).
...
tv.model = lm(Sales ~ log2(TV), data = advertising)
tidy(tv.model)
